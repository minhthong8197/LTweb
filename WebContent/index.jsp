...
<body>
	<div id="wrapper">
		...
		<div id="content">
			<div class="slider">
				<div class="camera_wrap" id="slider-id" style="height: 550px;">
			...
			<div class="hk-content">
				<div class="container">
					<div class="hk-left-ct">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										<a href="Subject_CuocSong.jsp"><img
											src="img/toan-canh-ba-na-hill.jpg"></a>
										<div class="info">
											<div>
												<a href="Subject_CuocSong.jsp"><h2>Cuộc Sống</h2></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										<a href="Subject_GiaoDuc.jsp"><img src="img/giaoduc.jpg"></a>
										<div class="info">
											<div>
												<a href="Subject_GiaoDuc.jsp"><h2>Giáo Dục</h2></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										<a href="Subject_GiaiTri.jsp"><img
											src="img/cong-vien-giai-tri-ngoai-troi-asia-park.jpg"></a>
										<div class="info">
											<div>
												<a href="Subject_GiaiTri.jsp"><h2>Giải trí</h2></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										<a href="Subject_CongNghe.jsp"><img src="img/congnghe.jpg"></a>
										<div class="info">
											<div>
												<a href="Subject_CongNghe.jsp"><h2>Công Nghệ</h2></a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="hk-banner">
							<a
								href="https://pub.accesstrade.vn/deep_link/4348612819757661914?url=https%3A%2F%2Ftravel.com.vn%2F"><img
								src="img/qc.jpg" /></a>
						</div>
						<!-- end hk-banner -->
					...
					<div class="hk-right-ct">
						<div class="hk-restaurant">
							...
							<a href="TinTuc.jsp" class="all">Xem tất cả</a>
			...
			<div class="hk-tour hk-qua">
				<div class="container pos">
					...
					<a href="TinTuc.jsp" class="view-all cn">Xem tất cả <i
						class="hk-ic"></i></a>
					<div class="row">
